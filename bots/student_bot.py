...
async def send_welcome(message):
    ...
    await bot.send_message(
        chat_id=message.from_user.id,
        text="Hello! To access this bot, you need to verify that you have a valid Covenant University email. Please sign in with your Google account using the button below.",
        reply_markup=markup,
    )
    ...
    try:
        ...
        if attachment.content_type == "audio":
            await bot.send_audio(
                user_id,
                audio=downloaded_attachment.file,
            ...
            await bot.send_photo(
                user_id,
                photo=downloaded_attachment.file,
                reply_parameters=reply_parameters,
                caption=message_caption,
            )
            ...
            await bot.send_voice(
                user_id,
                voice=downloaded_attachment.file,
                reply_parameters=reply_parameters,
            )
        elif attachment.content_type == "video":
            await bot.send_video(
                user_id,
                video=downloaded_attachment.file,
                reply_parameters=reply_parameters,
                caption=message_caption,
            )
            ...
            await bot.send_document(
                user_id,
                document=downloaded_attachment.file,
                reply_parameters=reply_parameters,
                caption=message_caption,
            )
